...
function RatingItem(props) {
  ...
  return (0, import_jsx_runtime19.jsxs)(React34.Fragment, {
...
var Rating = React34.forwardRef(function Rating2(inProps, ref) {
  const props = useThemeProps2({
    name: "MuiRating",
    props: inProps
  });
  ...
  const [emptyValueFocused, setEmptyValueFocused] = React34.useState(false);
  const ownerState = _extends({}, props, {
    defaultValue,
    disabled,
    emptyIcon,
